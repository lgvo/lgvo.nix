...
Last verified: **2026-08-28**, branch **`main`**.
...
- Shared Home Manager sources were classified from `/private/etc/nix-darwin/home` without copying
  nixvim, Neovim configuration, editor variables, or consumer-owned machine values. The shared
  module includes a default personal Git identity.
- The existing editor configuration remains an independent sibling at
  `https://github.com/lgvo/nvim.nix`.

## Validation state

- Alejandra formatting and Statix lint pass as of 2026-08-28.
...
- The default Git identity is assigned as an ordinary module value. Override-friendly merge
  behavior and a consumer-override evaluation assertion still need implementation and validation.
